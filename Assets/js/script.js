...
fetch(`https://world.openfoodfacts.org/api/v3/product/${item_code}`)
    ...
    .then(data => {
        ...
        <div class="col-lg-8 bg-white">
            ...
            <p class="mt-3"><span class="fw-bold">Pays de vente </span> : ${data.product.countries_tags.map(countries_tags => countries_tags.startsWith("en:") ? countries_tags.replace("en:", "") : countries_tags).join(", ")}</p>
            <!-- countries_hierarchy -->
        </div>
